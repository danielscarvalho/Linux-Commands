...
> Conhecimento duradouro em computação! Não é um conteúdo volátil que se perde no tempo...
...
Em meados dos anos 2000, trabalhei com [UNIX Solares](https://en.wikipedia.org/wiki/Oracle_Solaris) da Sun Microsystems, rodando aplicações corporativas em Java e BD Oracle, em servidores [Sun Enterprise](https://en.wikipedia.org/wiki/Sun_Enterprise) E1000 (E10K) entre outros equipamentos [Sun Fire](https://en.wikipedia.org/wiki/Sun_Fire). TUDO que aprendi com sistemas UNIX e rede continuam válido no Linux de hoje. É curioso como conhecimento de TI não é tão volátil quanto parece. Os fundamentos de computação são valiosos e de "longa duração".

<img src="https://www.computermuseum.org.uk/pictures/sun_e10000.gif" width="300px">
...
| `ls -l /usr/bin \| wc` | Conta quantos arquivos há na pasta de executáveis /bin | 
| `less /var/log/syslog` | Mostra as últimas linhas do log do Linux (mensagens de erro, etc...) | 
